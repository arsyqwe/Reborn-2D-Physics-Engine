# Reborn-2D-Physics-Engine
A custom-built 2D physics engine and grid-based sandbox environment developed from scratch using Java and LibGDX. 
Built without relying on pre existing physics libraries (like Box2D) to demonstrate core algorithmic problem solving and system architecture.
Core Features:
